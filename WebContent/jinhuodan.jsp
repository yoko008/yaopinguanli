...
<base href="<%=basePath%>">
    ...
    $(document).ready(function(){
    	...
    	$("#meiye").change(function(){
    		...
    		location.href="yaopin/yaopinAction!jinhuodan?page.newpage=1&page.pagelistnum="+pagelistnum;
    	});
    	//跳到指定页面
   ...
   <div class="sidebar-wrap">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="index.jsp">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">进货单管理</span></div>
        </div>
        <div class="search-wrap">
            <div class="search-content">
                <form action="yaopin/yaopinAction!jinhuodan?page.newpage=1" method="post">
            ...
            <form name="myform" id="myform" method="post">
                ...
                <div class="result-content">
                    <table id="table"  class="result-tab" width="100%">
                        ...
                        <s:iterator value="jinhuoList" var="jh" status="st">
                        <tr>
                            <td class="tc">${(page.currpage-1)*page.pagelistnum+st.index+1}
                            <input name="id" value="${jh.id}" type="hidden">
                            </td>
                            <td>${jh.yaopinname}</td>
                            <td>${jh.gongyingshang}</td>
                            <td>${jh.pici}</td>
                            <td>${jh.shengchandate}</td>
                            <td>${jh.guoqidate}</td>
                            <td>${jh.danwei}</td>
                            <td>${jh.shuliang}</td>
                            <td>${jh.danjia}</td>
                   ...
                   <div class="list-page"> 
                   共 ${page.listnum} 条结果 
                    <s:if test="page.currpage != 1"><a href="yaopin/yaopinAction!jinhuodan?page.newpage=1&page.pagelistnum=${page.pagelistnum}&page.keyword=${page.keyword}">首页</a></s:if> 
                    <s:if test="page.currpage == 1"><a ><font color="#aaaaaa">首页</font></a></s:if>
                    <s:if test="page.currpage != 1"><a href="yaopin/yaopinAction!jinhuodan?page.pagelistnum=${page.pagelistnum}&page.keyword=${page.keyword}&page.newpage=${page.currpage-1}">上一页</a></s:if> 
                    <s:if test="page.currpage == 1"><a ><font color="#aaaaaa">上一页</font></a></s:if> 
                    <s:if test="page.currpage != page.pagenum"><a href="yaopin/yaopinAction!jinhuodan?page.pagelistnum=${page.pagelistnum}&page.keyword=${page.keyword}&page.newpage=${page.currpage+1}">下一页</a></s:if>
                    <s:if test="page.currpage == page.pagenum"><a><font color="#aaaaaa">下一页</font></a></s:if>
                    <s:if test="page.currpage != page.pagenum"><a href="yaopin/yaopinAction!jinhuodan?page.pagelistnum=${page.pagelistnum}&page.keyword=${page.keyword}&page.newpage=${page.pagenum}">末页</a></s:if>
                   ...
                   第 ${page.currpage} 页/共 <font id="pagenum">${page.pagenum}</font> 页
                     <a id="pagelianjie" href="yaopin/yaopinAction!jinhuodan?page.pagelistnum=${page.pagelistnum}&page.keyword=${page.keyword}" style="float: right;">跳转</a><input id="tiaopage" style="float: right;" type="text">
                    </div>
                    </div>
                </div>
            </form>
