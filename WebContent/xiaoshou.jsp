   ...
   <div class="sidebar-wrap">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="index.jsp">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">出售药品</span></div>
        </div>
        ...
        <div class="result-wrap">
            <form action="yaopin/yaopinAction!addXiaoshou" name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                    <center>
                    <form >
                                                 药品名：<select  id="yaopin" name="xiaoshou.yaopinname">
                     ...
                     <s:iterator value="yaopininfoList" var="yp" status="st">
                         <option style="width: 130px;" value="${yp.name}">${yp.name}</option>
                                                 ...
                                                 数量：<input name="xiaoshou.shuliang" id="shuliang" type="text"><br>
                                                 单价：<input name="xiaoshou.danjia" id="danjia" type="text"><br>
                                                 总价：<input name="xiaoshou.zongjia" id="zongjia" type="text"><br><br> 
                     <input class="btn btn-primary btn2" value="出售"  type="submit">
                    </form>
                    </center>                         
                    </div>
                </div>
