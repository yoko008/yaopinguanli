...
<base href="<%=basePath%>">
    ...
    $(document).ready(function(){
    	...
    	$("#meiye").change(function(){
    		...
    		location.href="yaopin/yaopinAction!yaopininfo?page.newpage=1&page.pagelistnum="+pagelistnum;
    	});
   ...
   <div class="sidebar-wrap">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="index.jsp">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">药品信息管理</span></div>
        </div>
        <div class="search-wrap">
            <div class="search-content">
                <form action="yaopin/yaopinAction!yaopininfo?page.newpage=1" method="post">
        ...
        <div class="result-wrap">
                ...
                <div class="result-content">
                    <table id="table"  class="result-tab" width="100%">
                        ...
                        <tr id="${info.id}">
                           <td class="tc"><!-- <input name="id[]" value="59" type="checkbox"> -->
                            ...
                            <td class="yaopininfo.changjia">${info.changjia}</td>
                            <td class="yaopininfo.leibie">${info.leibie}</td>
                            <td class="yaopininfo.danwei">${info.danwei}</td>
                            <td><a class="del" data-tooltip="确定要删除 ${info.name} 吗？" href="yaopin/yaopinAction!delinfo?page.newpage=${page.currpage}&page.pagelistnum=${page.pagelistnum}&page.keyword=${page.keyword}&yaopininfo.id=${info.id}">删除</a></td>
                        </tr>
                        </s:iterator>
                        
                    </table>
                    
                   <div class="list-page"> <a  class="theme-login"  id="add" href="javascript:;" style="float: left;">添加药品信息</a>
                    共 ${page.listnum} 条结果 
                    <s:if test="page.currpage != 1"><a href="yaopin/yaopinAction!yaopininfo?page.newpage=1&page.pagelistnum=${page.pagelistnum}&page.keyword=${page.keyword}">首页</a></s:if> 
                    <s:if test="page.currpage == 1"><a ><font color="#aaaaaa">首页</font></a></s:if>
                    <s:if test="page.currpage != 1"><a href="yaopin/yaopinAction!yaopininfo?page.pagelistnum=${page.pagelistnum}&page.keyword=${page.keyword}&page.newpage=${page.currpage-1}">上一页</a></s:if> 
                    <s:if test="page.currpage == 1"><a ><font color="#aaaaaa">上一页</font></a></s:if> 
                    <s:if test="page.currpage != page.pagenum"><a href="yaopin/yaopinAction!yaopininfo?page.pagelistnum=${page.pagelistnum}&page.keyword=${page.keyword}&page.newpage=${page.currpage+1}">下一页</a></s:if>
                    <s:if test="page.currpage == page.pagenum"><a><font color="#aaaaaa">下一页</font></a></s:if>
                    <s:if test="page.currpage != page.pagenum"><a href="yaopin/yaopinAction!yaopininfo?page.pagelistnum=${page.pagelistnum}&page.keyword=${page.keyword}&page.newpage=${page.pagenum}">末页</a></s:if>
                   ...
                   第 ${page.currpage} 页/共 <font id="pagenum">${page.pagenum}</font> 页
                     <a id="pagelianjie" href="yaopin/yaopinAction!yaopininfo?page.pagelistnum=${page.pagelistnum}&page.keyword=${page.keyword}" style="float: right;">跳转</a><input id="tiaopage" style="float: right;" type="text">
                    </div> 
                    </div>
        </div>
    </div>
...
<div class="theme-popover">
     ...
     <div class="theme-popbod dform">
           <form class="theme-signin" name="loginform" action="yaopin/yaopinAction!addyaopininfo?page.newpage=1&page.pagelistnum=${page.pagelistnum}" method="post">
                <ol>
                     <li><h4>添加药品信息</h4></li>
                     <li><strong>名称：</strong><input class="ipt" type="text" name="yaopininfo.name" value="" size="20" /></li>
                     <li><strong>生产厂家：</strong><input class="ipt" type="text" name="yaopininfo.changjia" value="" size="20" /></li>
                     <li><strong>药品类别：</strong><input class="ipt" type="text" name="yaopininfo.leibie" value="" size="20" /></li>
                     <li><strong>单位：</strong><input class="ipt" type="text" name="yaopininfo.danwei" value="" size="20" /></li>
                     <li><input class="btn btn-primary" type="submit" name="submit" value=" 添加药品信息 " /></li>
                </ol>
           </form>
     </div>
</div>
