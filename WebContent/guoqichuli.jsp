   ...
   <div class="sidebar-wrap">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="index.jsp">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">过期/毁坏处理</span></div>
        </div>
        ...
        <div class="result-wrap">
            <form action="yaopin/yaopinAction!chuli" name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                    <center>
                    <form >
                                                 药品名：<select  id="yaopin"  name="yaopinchuli.yaopinname">
                     <option style="width: 130px;" value="">请选择药品</option>
                     <s:iterator value="yaopinkucunList" var="kc" status="st">
                         <option style="width: 130px;" value="${kc.yaopinname}">${kc.yaopinname}</option>
                     </s:iterator>
                     </select><br>
                                                 处理原因：<select  name="yaopinchuli.yuanyin">
                     <option style="width: 130px;" value="过期">过期</option>
                     <option style="width: 130px;" value="毁坏">毁坏</option>
                     </select><br>                     
                                                 数量：<input  name="yaopinchuli.shuliang" type="text"><br>
                                                 批次：<input name="yaopinchuli.pici" type="text"><br>                         
                     <input class="btn btn-primary btn2" value="处理"  type="submit">
                    </form>
                    </center>                         
                    </div>
                </div>
