...
<base href="<%=basePath%>">
    ...
    $(document).ready(function(){
    	...
    	$("#meiye").change(function(){
    		...
    		location.href="gongyingshang/gongyingshangAction!searchGYS?page.newpage=1&page.pagelistnum="+pagelistnum;
    	});
    	$(".result-tab td").dblclick(function() {
    	    ...
    	    $(".xiugai").blur(function(){
    	    	...
    	    	if(value!=text){
    	    		$.ajax({
        				type : "POST",
        				url : "gongyingshang/gongyingshangAction!updateGYS?gongyingshang.id="+id+"&"+gys+"="+value,
        				dataType : "json",
        				async : false,
   ...
   <div class="sidebar-wrap">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="index.jsp">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">供应商信息管理</span></div>
        </div>
        <div class="search-wrap">
            <div class="search-content">
                <form action="gongyingshang/gongyingshangAction!searchGYS?page.newpage=1" method="post">
        ...
        <div class="result-wrap">
                ...
                <div class="result-content">
                    <table id="table"  class="result-tab" width="100%">
                        <tr>
                            <th class="tc" width="5%">编号<!-- <input class="allChoose" name="" type="checkbox"> --></th>
                            <th>供应商</th>
                            <th>联系人</th>
                            <th>电话</th>
                            <th>地址</th>
                        ...
                        <s:iterator value="gongyingshangList" var="gys" status="st">
                            ...
                            ${(page.currpage-1)*page.pagelistnum+st.index+1}<input name="id" value="${gys.id}" type="hidden">
                            </td>
                            <td class="gongyingshang.name">${gys.name}</td>
                            <td class="gongyingshang.fuzeren">${gys.fuzeren}</td>
                            <td class="gongyingshang.phone">${gys.phone}</td>
                            <td class="gongyingshang.dizhi">${gys.dizhi}</td>
                            
                            <td>
                            <a class="del" data-tooltip="确定要删除 ${gys.name} 吗？" href="gongyingshang/gongyingshangAction!delGYS?page.newpage=${page.currpage}&page.pagelistnum=${page.pagelistnum}&page.keyword=${page.keyword}&gongyingshang.id=${gys.id}">删除</a></td>
                        </tr>
                        </s:iterator>
                        
                    </table>
                    
                   <div class="list-page"> <a  class="theme-login"  id="add" href="javascript:;" style="float: left;">添加供应商</a>
                    共 ${page.listnum} 条结果 
                    <s:if test="page.currpage != 1"><a href="gongyingshang/gongyingshangAction!searchGYS?page.newpage=1&page.pagelistnum=${page.pagelistnum}&page.keyword=${page.keyword}">首页</a></s:if> 
                    <s:if test="page.currpage == 1"><a ><font color="#aaaaaa">首页</font></a></s:if>
                    <s:if test="page.currpage != 1"><a href="gongyingshang/gongyingshangAction!searchGYS?page.pagelistnum=${page.pagelistnum}&page.keyword=${page.keyword}&page.newpage=${page.currpage-1}">上一页</a></s:if> 
                    <s:if test="page.currpage == 1"><a ><font color="#aaaaaa">上一页</font></a></s:if> 
                    <s:if test="page.currpage != page.pagenum"><a href="gongyingshang/gongyingshangAction!searchGYS?page.pagelistnum=${page.pagelistnum}&page.keyword=${page.keyword}&page.newpage=${page.currpage+1}">下一页</a></s:if>
                    <s:if test="page.currpage == page.pagenum"><a><font color="#aaaaaa">下一页</font></a></s:if>
                    <s:if test="page.currpage != page.pagenum"><a href="gongyingshang/gongyingshangAction!searchGYS?page.pagelistnum=${page.pagelistnum}&page.keyword=${page.keyword}&page.newpage=${page.pagenum}">末页</a></s:if>
                   ...
                   第 ${page.currpage} 页/共 <font id="pagenum">${page.pagenum}</font> 页
                     <a id="pagelianjie" href="gongyingshang/gongyingshangAction!searchGYS?page.pagelistnum=${page.pagelistnum}&page.keyword=${page.keyword}" style="float: right;">跳转</a><input id="tiaopage" style="float: right;" type="text">
                    </div> 
                    </div>
        </div>
    </div>
...
<div class="theme-popover">
     ...
     <div class="theme-popbod dform">
           <form class="theme-signin" name="loginform" action="gongyingshang/gongyingshangAction!addGYS?page.newpage=1&page.pagelistnum=${page.pagelistnum}" method="post">
                <ol>
                     <li><h4>添加供应商</h4></li>
                     <li><strong>名称：</strong><input class="ipt" type="text" name="gongyingshang.name" value="" size="20" /></li>
                     <li><strong>负责人：</strong><input class="ipt" type="text" name="gongyingshang.fuzeren" value="" size="20" /></li>
                     <li><strong>电话：</strong><input class="ipt" type="text" name="gongyingshang.phone" value="" size="20" /></li>
                     <li><strong>地址：</strong><input class="ipt" type="text" name="gongyingshang.dizhi" value="" size="20" /></li>
                     <li><input class="btn btn-primary" type="submit" name="submit" value=" 添加供应商 " /></li>
                </ol>
           </form>
     </div>
</div>
